...
@Component({
    selector: 'app-utl-footage',
    standalone: true,
    imports: [ImportsModule],
    template: ` <div class="card">
        <div class="font-semibold text-xl mb-4">Empty Page</div>
        <p>UTL Footage Works!</p>
        <div class="font-semibold text-xl mb-4"></div>
                        <p-accordion value="0">
                            <p-accordion-panel value="0">
                                <p-accordion-header>Week 1 League/UTL Practice</p-accordion-header>
                                <p-accordion-content>
                                    <p class="m-0">
                            ...
                            <p-accordion-panel value="1">
                                <p-accordion-header>Week 2 League/UTL Practice</p-accordion-header>
                                <p-accordion-content>
                                    <p class="m-0">
                            ...
                            <p-accordion-panel value="2">
                                <p-accordion-header>Week 3 League/UTL Practice</p-accordion-header>
                                <p-accordion-content>
                                    <p class="m-0">
                                        Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt
                                        explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Consectetur, adipisci velit, sed quia non
